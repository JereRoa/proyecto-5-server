...
mercadopago.configure({
    access_token: "TEST-3620090445823060-111715-4d5e0e446090640bd560243dfd65f327-1554457798"
})
...
app.post("/crear-producto", async (req, res) => {
    ...
    try {
        ...
        const nuevoProducto = await Producto.create({ producto, precio, imagen, color })
...
app.put("/actualizar-producto", async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({
            msg: "Hubo un error actualizando producto"
        })
...
// 4. SERVIDOR
app.listen(process.env.PORT, () => console.log("El servidor está de pie " + process.env.PORT))